...
(1, 'Resident evil vingança', '2017-05-27', 1),
(2, 'Vingadores ultimato', '2019-04-22', 2),
(3, 'O hóspede', '2014-09-17', 3),
(4, 'O hóspede', '1955-10-20', 4);
...
ALTER TABLE `detalhes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_detalhe_do_filme` (`filme_id`);
...
--
ALTER TABLE `detalhes`
  ADD CONSTRAINT `fk_detalhe_do_filme` FOREIGN KEY (`filme_id`) REFERENCES `filmes` (`id`);

--
-- Restrições para tabelas `filmes`
--
ALTER TABLE `filmes`
  ADD CONSTRAINT `fk_filme_genero` FOREIGN KEY (`genero_id`) REFERENCES `generos` (`id`);
COMMIT;
